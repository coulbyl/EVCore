# EVCore — Archive Mois 2 : Odds, EV, simulation

Période: mars 2026
Milestone: `mvp-month-2`
Statut: **Terminé** — 98 tests passants
...
> Migration complète : abandon API-Sports + Understat + FBref → API-FOOTBALL single key + football-data.co.uk CSV.
