...
import { Popover, PopoverContent, PopoverTrigger } from "@evcore/ui/components/popover"
...
function DatePicker({ value, onChange, placeholder = "Choisir une date", className, disabled }: DatePickerProps) {
  return (
    <Popover>
...
function DateRangePicker({ value, onChange, placeholder = "Choisir une période", className, disabled }: DateRangePickerProps) {
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button
