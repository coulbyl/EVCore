# Script vidéo — Intro Formation EVCore
...
EVCore est un outil d’analyse. Le moteur lit les matchs, compare probabilités et cotes, puis affiche des signaux.

Toi, tu gardes toujours la décision finale. L’app ne remplace pas ton jugement, elle structure ta lecture.
...
## 2:35 — 3:15 | Ce qu’on fait dans l’app
...
Et si le modèle affiche `Passer`, cela veut juste dire : pas de signal assez fort selon ses règles. Ce n’est pas une interdiction.

## 3:15 — 3:45 | Discipline et bankroll

La partie la plus importante n’est pas seulement le pick. C’est la discipline.

Dans EVCore, tu peux suivre ta bankroll, choisir une unité fixe ou un pourcentage, et garder une logique stable dans le temps.

L’objectif n’est pas de forcer plus de paris. L’objectif, c’est de mieux lire les signaux et de rester cohérent.
