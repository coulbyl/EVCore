...
related:
  ["value-channel", "safe-channel", "the-3-channels", "comment-lire-un-pick"]
---
...
- le **résultat prédit** — V1 ou V2
- la **probabilité estimée** — ex. 73 %
- un **indicateur de résultat** une fois le match terminé (correct / incorrect)

## Pourquoi c'est un signal de pari

Si le modèle estime qu'une issue a 73 % de probabilité, c'est une information directement exploitable. Tu peux choisir de parier sur cette issue en te fiant à la probabilité du modèle plutôt qu'à la valeur de la cote.
...
Apprendre à lire un pick complet dans l'app : `comment-lire-un-pick`.
