...
// overUnderOpposite/oppositePick/siblingOutcomeOdds/computeMarketFair moved
// to packages/analysis-core/src/pricing/market-fair.ts 2026-09-03 — pure
// odds math with no Prisma/NestJS dependency, needed by apps/vantage-worker's
// own pool-building query too (see docs/vantage-centric-redesign-2026-09-01.md
// §9bis). `oppositePick` is still used below (the FADE regime construction).
