// Pure scoring/calibration helpers shared by the per-channel backtest and the
// model-quality backtest. No I/O. (The legacy season-by-season report types
// were removed with the god-class backtest service in the channel redesign.)
