-- Snapshot daily policy at 00:00 UTC, before any outcome of the day.
...
COPY (
 WITH latest AS (
  ...
  WHERE mr."analyzedAt"<date_trunc('day',f."scheduledAt") AND mr."createdAt"<date_trunc('day',f."scheduledAt")
    AND cd."createdAt"<date_trunc('day',f."scheduledAt")
